        ...
        <section className='py-10'>
            <div className='flex flex-col items-center text-center p-10'>
                ...
                <div className='mt-5 flex'>
                    <Link to='blog'><button className='btn prime-btn mr-5 flex items-center'>Learn More <BookOpenIcon className="w-6 h-6 ml-3"/></button></Link>
                    <Link to='quizes'><button className='btn second-btn flex items-center'>Get Quize <ArrowRightIcon className="w-6 h-6 ml-3"/></button></Link>
                </div>
            </div>
